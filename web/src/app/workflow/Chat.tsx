  ...
  const onSubmit = async ({
    ...
    let retrievalType: RetrievalType =
      selectedDocuments.length > 0
        ...
        : RetrievalType.None;
    let issues: Issue[] = selectedIssues;
      ...
      for await (const packetBunch of sendMessage({
        ...
        for (const packet of packetBunch) {
          if (Object.hasOwn(packet, "answer_piece")) {
            ...
            issues = (packet as IssuesResponse).top_issues;
        ...
        setMessageHistory([
          ...
          },
          {
            ...
            documents: [],
            issues: finalMessage?.issues?.top_issues || issues,
    ...
    if (isNewSession) {
      ...
      if (
        ...
        router.push(`/workflow?chatId=${currChatSessionId}`, {
          scroll: false,
        });
      }
    }
