      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for Mergify. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow Mergify to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the Mergify integration."
                ),
              })}
              initialValues={{
