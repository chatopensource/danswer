  ...
  return (
    <>
      <Text>
        ...
        will be queryable within Mergify.
      </Text>
          ...
          <ConnectorForm<SharepointConfig>
            ...
            formBodyBuilder={TextArrayFieldBuilder({
              ...
              subtext:
                ...
                "'support' for the 'Mergifyai' sharepoint will cause us to only index documents " +
                "within the 'https://Mergifyai.sharepoint.com/sites/support' site. " +
