    ...
    <div className="mt-2">
      <p className="text-sm mb-2">
        ...
        <a
          className="text-link"
          target="_blank"
          href="https://docs.Mergify.dev/connectors/gmail#authorization"
        >
          here
        </a>{" "}
...
export const GmailOAuthSection = ({
  ...
  if (serviceAccountKeyData?.service_account_email) {
    return (
      <div>
        <p className="text-sm mb-2">
          When using a Gmail Service Account, you can either have Mergify act as
            ...
            {({ isSubmitting }) => (
              <Form>
                <TextFormField
                  ...
                  subtext="If left blank, Mergify will use the service account itself."
                />
                <div className="flex">
                  <button
                    type="submit"
