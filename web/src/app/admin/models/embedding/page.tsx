  ...
  return (
    <div>
        ...
        <Modal>
          <div>
            <div>
              ...
              <br />
              <br />
              Connectors are the way that Mergify gets data from your
              organization&apos;s various data sources. Once setup, we&apos;ll
              automatically sync data from your apps and docs into Mergify, so
      ...
      <Text>
        ...
        which then power Mergify&apos;s search.
      </Text>
