...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to Mergify. Once setup, you will be able
        to ask questions to Mergify directly from Slack. Additionally, you can:
      </Text>

      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup Mergify to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets Mergify should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message Mergify to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      <Text className="mb-6">
        ...
        found in the Mergify documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup Mergify</Title>
          <Text className="mb-3">
            Configure Mergify to automatically answer questions in Slack
            channels. By default, Mergify only responds in channels where a
