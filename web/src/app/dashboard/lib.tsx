...
export async function* sendMessage({
  ...
  const sendMessageResponse = await fetch("/api/chat/send-issue", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  yield* handleStream<
    AnswerPiecePacket | DocumentsResponse | BackendMessage | StreamingError | IssuesResponse // Include IssueResponse here
  >(sendMessageResponse);
}
