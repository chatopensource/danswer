  ...
  return (
    <Modal className="max-w-4xl">
      <div className="text-base">
        ...
        <div>
          <p>
            Mergify is the AI-powered search engine for your organization&apos;s
            internal knowledge. Whenever you need to find any piece of internal
            information, Mergify is there to help!
          </p>
        </div>
        ...
        {!validModelSelected && (
          <>
            ...
            Mergify&apos;s search. Different models have different strengths,
        ...
        way that Mergify gets data from your organization&apos;s various data
        sources. Once setup, we&apos;ll automatically sync data from your apps
        and docs into Mergify, so you can search all through all of them in one
        place.
        <div className="flex mt-3">
